	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px;"><input id="agree" type="checkbox" name="agreement1" value="">이용약관과 개인정보취급방침에 동의합니다.</p>
...
<!-- 				<p style="text-align:center; margin-bottom:20px"><a href="join02.jsp"><img src="../images/btn01.gif" /></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
				...
				<p style="text-align:center; margin-bottom:20px">
               		<input type="image" onclick="agreeCheck(this.fn);" src="../images/btn01.gif"" alt="확인">&nbsp;&nbsp;<input type="image" src="../images/btn02.gif"" alt="취소">
            	</p>
